...
<head>
    ...
    <!-- Cartzila Theme -->
    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/simplebar/dist/simplebar.min.css"/>
    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/tiny-slider/dist/tiny-slider.css"/>
    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/drift-zoom/dist/drift-basic.min.css"/>
    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/lightgallery.js/dist/css/lightgallery.min.css"/>

    <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/theme.min.css">

    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/simplebar/dist/simplebar.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/tiny-slider/dist/min/tiny-slider.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/drift-zoom/dist/Drift.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/lightgallery.js/dist/js/lightgallery.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/vendor/lg-video.js/dist/lg-video.min.js"></script>
   
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/theme.min.js"></script>
    <!-- End Cartzila Theme -->
